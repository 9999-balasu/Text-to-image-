...
<div>
    ...
    <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI 
        ...
        describe it, and watch it ,and watch it come to life instantly.
    </p>
    <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge 
        ...
        product visuals to character designs and port
        even concepts that don't yet exist can be visualized 
        effortlessly.Powered by advanced AI technology, the crative possiblites are limitless
    </p>
</div>
      </div>
    </div>
