...
const onSubmitHandler = async(e) => async (e) =>{
...
{!isImageLoaded &&
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 round-full'>
      <input 
...
{isImageLoaded &&
    ...
    text-sm p-0.5 mt-10 rounded-full'>
      ...
      text-black px py-3 rounded-full cursor pointer'>Generate Another</p>
